    ...
    return (
        <section id="leadership" className="py-24 px-6 max-w-7xl mx-auto space-y-20">
            ...
            <div className="flex flex-col items-center space-y-16">
                {/* Mayor Card */}
                <Link href={`/user/leadership/${mayor.id}`} className="block">
                    <motion.div
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <h3 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter leading-tight group-hover:text-primary transition-colors">{mayor.name}</h3>
