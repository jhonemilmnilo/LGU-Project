            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-8 animate-in fade-in duration-300">
                        ...
                        {/* TREASURY RELEASE VERDICT AND UPLOAD CONTROLLER */}
                            ...
                            <div className="space-y-6">
                                <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-6">
                                    <div className="text-center space-y-3">
                                        ...
                                        <h4 className="text-sm font-black uppercase tracking-[0.25em] text-slate-800 dark:text-slate-200 font-bold">Registry Record Processing</h4>
                                        <p className="text-xs text-slate-400 italic max-w-sm mx-auto">
                                            Please verify the presence of this record in the Municipal registry archives and upload the scanned copies below.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-4 pt-4 border-t border-slate-800/50">
                                        <label className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 ml-1">
                                            Verification Status <span className="text-rose-500 font-extrabold">*Required</span>
                                        </label>
                                        <div className="grid grid-cols-1 gap-2">
                                            {[
                                                { code: "FORM_2A", title: "Form 2A (Record Found)", desc: "Confirm record matches search request parameters" },
                                                { code: "FORM_2B", title: "Form 2B (Record Not Available)", desc: "Registry archives search yields negative results" },
                                                { code: "FORM_2C", title: "Form 2C (Record Destroyed)", desc: "Archive registry volume is damaged or missing" }
                                            ].map((opt) => {
                                                const isSelected = registryBookVerification === opt.code;
                                                return (
                                                    <button
                                                        key={opt.code}
                                                        type="button"
                                                        onClick={() => setRegistryBookVerification?.(opt.code)}
                                                        className={cn(
                                                            "w-full p-4 rounded-2xl border text-left flex justify-between items-center transition-all",
                                                            isSelected
                                                                ? "border-primary bg-primary/5 text-primary shadow-sm"
                                                                : "border-slate-800 text-slate-400 hover:text-slate-200 hover:bg-white/[0.02]"
                                                        )}
                                                    >
                                                        <div className="flex flex-col">
                                    ...
                                    {/* E-Copy/Verification PDF/Image Upload Block */}
                                    {registryBookVerification && (
                                    ...
                                    {/* Official E-Copy Registry Record */}
                                    {registryBookVerification && deathRegDocFile && (
                                        <div className="space-y-3 pt-4 border-t border-slate-800/50">
                                    ...
                                    <Button
                                        ...
                                        disabled={actionLoading || !registryBookVerification || !deathRegDocFile || !eCopyFile}
...
export default function DeathCertificateView(props: TreasuryViewProps) {
    ...
    const subjectName = transaction.deathCertificateRequest?.subjectName || additional.fullName || additional.subjectName || "N/A";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        ...
                        <div className="bg-[#111827] border border-slate-800 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-8 animate-in fade-in duration-300">
                            ...
                            {additional.registryBookVerification && (
                                <div className="flex items-center justify-between p-6 rounded-3xl bg-[#1f2937]/30 border border-slate-800 gap-4">
                                    <div className="space-y-1">
                                        <span className="text-[8px] font-black uppercase tracking-widest text-slate-500 block leading-none">Registry Status Choice</span>
                    ...
                    <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-8 animate-in fade-in duration-300">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="p-4 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 rounded-2xl">
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center">
                                                    <span className="text-[9px] font-black text-white tracking-widest uppercase italic bg-primary px-3 py-1 rounded-full flex items-center gap-1.5" style={{ backgroundColor: themeColor }}>
                                                        <Eye className="w-3 h-3" /> Zoom Receipt
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        {transaction.status === "FOR_PROCESSING" && (
                            <div className="space-y-6">
                                <div className="bg-[#111827] border border-slate-800 rounded-[2rem] p-8 shadow-2xl space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2 pt-4 border-t border-slate-800/50">
                                            <label className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400 dark:text-slate-500 italic block">
                                                Registry Number <span className="text-rose-500 font-extrabold">*Required</span>
                                            </label>
                                            <input
                                                type="text"
                                                value={ctcNumber}
                                                onChange={(e) => setCtcNumber(e.target.value)}
                                                placeholder="Enter Registry Number (e.g. 2026-1234)..."
                                                className="w-full h-11 px-4 rounded-xl border border-slate-800 bg-[#151b28]/60 text-xs font-bold text-slate-100 placeholder-slate-500 focus:outline-none focus:border-primary transition-all"
                                            />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <Button
                                    onClick={handleRelease}
                                    disabled={actionLoading || !registryBookVerification || !birthRegDocFile || !ctcNumber.trim()}
                                    className={`w-full rounded-xl h-12 text-xs font-black uppercase tracking-widest italic text-white ${themeColor}`}
                                >
                                    {actionLoading
                                        ? "Releasing Request..."
                            ...
                            <div className="space-y-6">
                                <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-6">
                                    <div className="text-center space-y-3">
                                        ...
                                        <h4 className="text-sm font-black uppercase tracking-[0.25em] text-slate-800 dark:text-slate-200 font-bold">Ready For Claiming</h4>
                                        <p className="text-xs text-slate-400 italic max-w-sm mx-auto">
                                            The document has been successfully processed and is currently waiting for the citizen to claim it at the Municipal Hall.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <Button
                                    onClick={handleRelease}
                                    disabled={actionLoading}
                                    className="w-full h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl shadow-lg font-black uppercase text-xs tracking-wider flex items-center justify-center active:scale-95 transition-all"
                                >
                                    {actionLoading && <RotateCw className="w-4 h-4 animate-spin mr-2" />}
                        ...
                        {/* RELEASED DOCUMENT COMPLETED NOTICE */}
                        {["RELEASED", "DELIVERED"].includes(transaction.status) && (
                            <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-4 text-center">
                                <div className="w-16 h-16 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500 mx-auto">
                                    <Check className="w-8 h-8" />
                                </div>
                                <h4 className="text-sm font-black uppercase tracking-[0.2em] text-slate-800 dark:text-slate-200 font-bold">Document Released</h4>
                                <p className="text-xs text-slate-400 italic max-w-sm mx-auto">
                                    This certified true copy has been successfully released and given to the applicant.
                                </p>
                            </div>
                        )}
                    </div>
