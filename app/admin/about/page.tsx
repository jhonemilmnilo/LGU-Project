    ...
    return (
        <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6 pb-20">
            <div className="bg-blue-600/10 dark:bg-blue-900/20 px-8 py-10 rounded-3xl border border-blue-100 dark:border-blue-900/30">
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium tracking-wide">Manage the historical information, mission, vision, and the official message here. Content displays live on the public `/about` page.</p>
            </div>
