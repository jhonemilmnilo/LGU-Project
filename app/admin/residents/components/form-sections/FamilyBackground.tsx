    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                <h4 style={{ borderColor: themeColor }} className="font-bold text-slate-700 dark:text-slate-300 uppercase text-xs tracking-widest border-l-4 pl-3">Mother&apos;s Maiden Name</h4>
            ...
            <div className="space-y-4">
                <h4 style={{ borderColor: themeColor }} className="font-bold text-slate-700 dark:text-slate-300 uppercase text-xs tracking-widest border-l-4 pl-3">Father&apos;s Name</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
