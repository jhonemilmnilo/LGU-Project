            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        ...
                        <TransactionInfoCard
                            transactionName="Marriage License Application "
                        ...
                        <ResidentIdentityProfile
                            ...
                            themeColor={themeColor}
                            titleColorText="Requester"
                            titleWhiteText="Profile"
                            subtitleText="Verified Citizen Profile who submitted this protocol"
                        ...
                        <div className="bg-white dark:bg-[#111827] border border-slate-100 dark:border-slate-800 rounded-[2.5rem] p-8 md:p-12 shadow-xl dark:shadow-2xl space-y-8 animate-in fade-in duration-300">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-500 italic">
                                    Marriage License Protocol Details
                                </h3>
                            </div>
                    ...
                    <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-8 animate-in fade-in duration-300">
                        ...
                        {/* WORKFLOW ACTION CONSOLE CONTAINER */}
                        <div className="space-y-6">
                            {/* REJECTION / REVISION CONTROLS */}
                            ...
                            {/* FLOW INTERACTIVE SECTIONS */}
                            {transaction.status === "FOR_INSPECTION" && (
                                <div className="space-y-6 pt-4 animate-in fade-in duration-300">
                                    <Button
                                        onClick={handleProcessRequest}
                                        disabled={actionLoading}
                                        className={`w-full text-xs font-black uppercase tracking-widest h-14 rounded-2xl text-white italic shadow-lg shadow-primary/15 ${themeColor} relative group overflow-hidden transition-all active:scale-95`}
                                    >
                                        PROCESS REQUEST
                                    </Button>
                            ...
                            {["FOR_REQUESTING", "EVALUATED"].includes(transaction.status) && (
                            ...
                            {(transaction.status === "PAID" || transaction.status === "PENDING_PAYMENT_VERIFICATION") && (
                                <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-4 text-center animate-in fade-in duration-300">
                                    ...
                                    <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-700 dark:text-slate-200 font-bold">Awaiting Treasury Verification</h4>
                                    <p className="text-[10px] text-slate-400 italic max-w-xs mx-auto">
                            ...
                            {/* LCR RELEASE ACTION PANEL (Active under processing state for Registrar) */}
                            {transaction.status === "FOR_PROCESSING" && isReadOnlyAide && (
                                <div className="space-y-6 pt-4 animate-in fade-in duration-300">
                                    <div className="p-4 bg-amber-500/10 rounded-2xl border border-amber-500/20 space-y-2">
                                        <h4 className="text-[9px] font-black uppercase tracking-widest text-amber-500 italic">Awaiting Processing</h4>
                                        <p className="text-slate-400 font-medium italic text-xs leading-relaxed">
                                            The request is currently awaiting LCR processing. Registrar team is generating the official license document.
                                        </p>
                                    </div>
                                </div>
                            )}

                            {/* REGISTRAR RELEASE SCREEN */}
                                ...
                                <div className="space-y-6 pt-4 animate-in fade-in duration-300">
                                    <div className="bg-[#111827] border border-slate-800 rounded-[2rem] p-8 shadow-2xl space-y-6">
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs font-bold text-slate-500 italic">Verify documents, attach license registry serial, and release e-copy.</p>
                                        </div>

                                        <div className="space-y-4">
                                            <div className="space-y-2">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block leading-none">Upload E-Copy PDF Document</span>
                                                <div className={cn(
                                                    "relative rounded-3xl border-2 border-dashed transition-all bg-[#18202f] overflow-hidden group cursor-pointer",
                                                    eCopyFile ? "border-primary/30 bg-primary/5 shadow-inner h-36" : "border-slate-800 hover:border-primary/30 h-14"
                                                )}>
                                                    <input
                                                        type="file"
                                                        ...
                                                        className={cn(
                                                            ...
                                                            eCopyFile ? "pointer-events-none z-0" : "z-20"
                                                        )}
                                                    />
                                                    {eCopyFile ? (
                                                        <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center select-none z-10">
                                                            ...
                                                            <button
                                                                ...
                                                                className="absolute top-2 right-2 w-7 h-7 rounded-full bg-red-650 hover:bg-red-650/80 text-white flex items-center justify-center transition-all z-30 active:scale-95 shadow-md border border-white/20"
                                                                title="Remove file"
                                                            >
                                                                <Trash2 className="w-3.5 h-3.5" />
                                                            </button>

                                                            {eCopyFile.type.startsWith("image/") ? (
                                                                    ...
                                                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center z-20">
                                                                        <button
                                                                            ...
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                                                                e.preventDefault();
                                                                                handleViewFile?.(eCopyPreview || null, "Uploaded E-Copy Document");
                                                                            }}
                                                                            style={{ backgroundColor: themeColor }}
                                                                            className="backdrop-blur-md px-4 py-2 rounded-full border border-white/20 flex items-center justify-center text-white font-black italic uppercase tracking-widest text-[9px] shadow-lg hover:scale-105 transition-all"
                                                                        >
                                                                ...
                                                                <div className="relative w-full h-full flex flex-col items-center justify-center gap-2 group">
                                                                    ...
                                                                    <span className="text-[9px] font-black uppercase italic tracking-widest text-white max-w-[200px] truncate">{eCopyFile.name}</span>
                                                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center z-20">
                                                                        <button
                                                                            type="button"
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                                                                e.preventDefault();
                                                                                handleViewFile?.(eCopyPreview || null, "Uploaded E-Copy PDF File");
                                                                            }}
                                                                            style={{ backgroundColor: themeColor }}
                                                                            className="backdrop-blur-md px-4 py-2 rounded-full border border-white/20 flex items-center justify-center text-white font-black italic uppercase tracking-widest text-[9px] shadow-lg hover:scale-105 transition-all"
                                                                        >
                                                        ...
                                                        <div className="absolute inset-0 flex items-center justify-center gap-2 text-slate-500 group-hover:text-slate-350 transition-colors z-10 pointer-events-none">
                                                            <Upload className="w-4 h-4" />
                                                            <span className="text-[10px] font-black uppercase tracking-widest truncate max-w-[200px]">
                                                                SELECT E-COPY DOCUMENT
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
                                    ...
                                    <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-6">
                                        ...
                                        {(transaction.eCopyUrl || additional.eCopyUrl) && (
                                            <div className="p-6 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-white/5 space-y-4 text-left">
                                                <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-500 block">e-copy of documents</span>
                                                <div
                            ...
                            {(transaction.status === "RELEASED" || transaction.status === "DELIVERED") && (
                                <div className="space-y-6 pt-4 animate-in fade-in duration-300">
                                    <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-6">
                                        ...
                                        {(transaction.eCopyUrl || additional.eCopyUrl) && (
                                            <div className="p-6 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-white/5 space-y-4 text-left animate-in fade-in duration-350">
                                                <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-500 block">e-copy of documents</span>
                                                <div
                                                    onClick={() => handleViewFile?.(transaction.eCopyUrl || additional.eCopyUrl, "Issued Registry Record")}
                                                    className="relative aspect-[16/9] w-full rounded-2xl bg-slate-950 overflow-hidden border border-slate-100 dark:border-white/5 group hover:border-primary/50 transition-all cursor-pointer select-none"
