            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-8 animate-in fade-in duration-300">
                        ...
                        {/* AWAITING CITIZEN PAYMENT / PAYMENT CONFIRMED NOTICE */}
                        {["EVALUATED", "UNPAID", "PAID"].includes(transaction.status) && (
                            <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-4 text-center animate-in fade-in duration-300">
                                <div className={cn(
                                    "w-12 h-12 rounded-full flex items-center justify-center mx-auto",
                                    transaction.status === "PAID" ? "bg-green-500/10 text-green-500" : "bg-amber-500/10 text-amber-500"
                                )}>
                                    <Clock className="w-6 h-6 animate-pulse" />
                                </div>
                                <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-700 dark:text-slate-200 font-bold">
                                    {transaction.status === "PAID" ? "Payment Confirmed" : "Awaiting Citizen Payment"}
                                </h4>
                                <p className="text-[10px] text-slate-400 italic max-w-xs mx-auto">
                                    {transaction.status === "PAID"
                                        ? "Payment has been confirmed. The request is proceeding to the next processing phase."
                            ...
                            <div className="space-y-6 animate-in fade-in duration-300">
                                ...
                                <div className="p-8 rounded-[2rem] bg-white dark:bg-[#151b28] border border-slate-100 dark:border-white/5 shadow-2xl space-y-6">
                                    <div className="text-left space-y-3">
                                        <h4 className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400 dark:text-slate-500 italic block leading-none">Released Document Details</h4>
                                    </div>
