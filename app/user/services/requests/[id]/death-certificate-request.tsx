...
interface DeathCertificateRequestDetailsProps {
    additionalData: {
        subjectName?: string;
        dateOfEvent?: string;
        placeOfEvent?: string;
...
export function DeathCertificateRequestDetails({ additionalData }: DeathCertificateRequestDetailsProps) {
    ...
    return (
        <div className="space-y-6 pb-8 border-b border-slate-100 dark:border-white/5">
            <h4 className="text-[9px] md:text-[11px] font-black uppercase tracking-widest text-primary italic border-l-4 border-primary pl-4">
                Death Certificate Request Details
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 space-y-4">
                    <div className="flex items-center gap-2 text-primary">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-wider">Deceased Identity</span>
                    </div>
...
interface DeathCertificateVerificationCardProps {
    request: any;
    additionalData: any;
    themeColor: string;
...
export function DeathCertificateVerificationCard({ request, additionalData, themeColor, handleViewFile }: DeathCertificateVerificationCardProps) {
            ...
            <div className="relative z-10 space-y-6">
                ...
                {(formType === "FORM_2B" || formType === "FORM_2C") && (
                    ...
                    >
                        ...
                        >
                            <Link href="/user/services/civil-registry/death-registration">
