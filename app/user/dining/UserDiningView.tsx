                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="space-y-0.5">
                            <h1 className="text-2xl md:text-5xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter leading-none">Dining Hub</h1>
                            <p className="text-[8px] md:text-[10px] font-bold text-primary uppercase tracking-[0.3em] ml-1">Kainan at Sarap</p>
                        </div>
                    </div>
                </div>
