                ...
                {stats.total > 0 && (
                    <div className="flex items-center gap-4 bg-slate-900/60 backdrop-blur-xl px-6 py-4 rounded-[2rem] border border-slate-850 dark:border-white/5 shadow-xl w-fit">
                        <div className="text-center">
                            ...
                            <span className="text-slate-555 font-bold text-xs italic">/5</span>
                        </div>
                        ...
                        <div>
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest text-slate-555 italic mt-0.5 block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 bg-slate-900/50 backdrop-blur-xl p-6 md:p-8 rounded-[2.5rem] border border-slate-800/80 shadow-2xl relative overflow-hidden group space-y-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-[10px] font-bold text-slate-505 uppercase tracking-widest italic">One review per user</p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2 relative">
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-2xl border border-slate-800/80 bg-slate-950/40 p-4 text-xs font-semibold text-slate-100 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 placeholder:text-slate-655 transition-all"
                                />
                            </div>
                    ...
                    <AnimatePresence mode="popLayout" initial={false}>
                        {filteredReviews.length === 0 ? (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}
                                className="flex flex-col items-center justify-center p-16 bg-slate-900/40 backdrop-blur-xl border border-slate-855 rounded-[2.5rem] text-center shadow-md"
                            >
                            ...
                            <div className="space-y-4 max-h-[600px] overflow-y-auto pr-3 custom-scrollbar">
                                {filteredReviews.map((review) => (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0 }}
                                        className="p-5 bg-slate-900/40 backdrop-blur-md border border-slate-800/60 rounded-[2rem] shadow-lg hover:border-slate-700/80 transition-all duration-300 space-y-4 group/card relative"
                                    >
