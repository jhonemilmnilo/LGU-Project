...
import { Newspaper, Calendar, User, Home, Search, Filter } from "lucide-react";
        ...
        <div className="space-y-6 md:space-y-12 pb-20">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="text-[8px] md:text-[10px] font-bold text-primary uppercase tracking-[0.3em] ml-1">LGU Official Stories</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 px-2 md:px-0">
                {filteredNews.map((item, idx) => (
                    ...
                    >
                        <Link href={`/user/news/${item.id}`} className="block h-full">
            ...
            {filteredNews.length === 0 && (
                <div className="mx-4 md:mx-0 py-24 text-center border-2 border-dashed border-slate-200 dark:border-white/5 rounded-[2.5rem] md:rounded-[4rem] bg-white dark:bg-black/10">
                    ...
                    <p className="text-slate-400 font-black uppercase tracking-[0.2em] italic text-xs md:text-base">No news articles found...</p>
                </div>
            )}
        </div>
    );
