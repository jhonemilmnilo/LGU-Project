            ...
            <div className="flex items-center justify-between">
                ...
                <Breadcrumb className="hidden sm:block">
                    <BreadcrumbList className="bg-white/50 dark:bg-white/5 backdrop-blur-sm px-4 py-1.5 rounded-xl border border-slate-100 dark:border-white/5 w-fit shadow-sm">
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage className="text-[9px] font-black uppercase tracking-widest text-blue-600 italic">{project.title.slice(0, 20)}...</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
                    ...
                    >
                        ...
                        <div className="absolute top-4 left-4">
                            <span className={cn(
                                ...
                                project.status === "Completed" ? "bg-emerald-500 text-white" : "bg-blue-600 text-white"
                            )}>
                                {project.status}
                            </span>
                        </div>
                ...
                <div className="lg:col-span-3 space-y-8">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 italic">{project.category}</span>
                        </div>
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-400 font-medium italic leading-relaxed whitespace-pre-line border-l-4 border-blue-600/20 pl-6 py-2">
                        {project.description}
                    </p>
                    ...
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/10 rounded-[1.5rem] border border-blue-100 dark:border-blue-900/20 text-blue-600 dark:text-blue-400">
