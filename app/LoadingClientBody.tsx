...
import { Landmark, ShieldCheck, Cpu, Database, Activity } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 opacity-[0.4] dark:opacity-[0.6] pointer-events-none">
                ...
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-primary/20 blur-[140px] rounded-full animate-pulse-glow" style={{ animationDuration: '4s' }} />
                <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-indigo-500/10 blur-[140px] rounded-full animate-pulse-glow" style={{ animationDelay: '1.5s', animationDuration: '5s' }} />
            </div>
            ...
            <div className="relative flex flex-col items-center gap-20 z-10 w-full max-w-xl px-12">
                ...
                >
                    <div className="w-32 h-32 md:w-40 md:h-40 bg-white dark:bg-slate-900 rounded-[3rem] flex items-center justify-center border border-slate-200 dark:border-white/10 shadow-3xl relative overflow-hidden group">
                        ...
                        {/* Shimmer on Logo */}
                        <div className="absolute top-0 left-[-100%] h-full w-full bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-[-20deg] animate-shimmer" style={{ animationDuration: '4s' }} />
                    </div>
                </motion.div>
                    ...
                    <div className="flex items-center gap-0 overflow-hidden px-4 py-2">
                        ...
                        {(brand2 || "PORTAL").split("").map((char, i) => (
                            <motion.span
                                ...
                                animate={{ y: 0, opacity: 1, rotateX: 0 }}
                                transition={{ 
                                    delay: 0.8 + (i * 0.08), // Delay to start after first word
                                    type: "spring", 
                                    stiffness: 70,
                                    damping: 10
                                }}
                    ...
                    <div className="flex flex-col items-center gap-10 w-full">
                        ...
                        <div className="w-full h-[3px] bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden relative border border-slate-200 dark:border-white/5 shadow-inner">
                            ...
                            <div 
                                ...
                                style={{ animationDuration: '2s', background: `linear-gradient(to right, transparent, ${themeColor}66, transparent)` }} 
                            />
                        </div>
                    </div>
                </div>
